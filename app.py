...
.party-badge {
    ...
    box-shadow: 0 0 10px #ff00ff, 0 0 15px #00eaff;
}
...
/* Buttons */
.stButton>button {
    background: linear-gradient(90deg, #00eaff, #ff00ff) !important;
...
st.markdown(
    f"""
    ### Current Order for Party:
    <span class='party-badge'>{party_name}</span>
    """,
    unsafe_allow_html=True
)
